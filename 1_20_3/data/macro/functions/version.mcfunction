...
tellraw @s ["",{"text":"  ┃ ","color":"#555555"},{"text":"Author    ","color":"gray"},{"text":"tickwarden","color":"#00ff33"},{"text":"  /  ","color":"#555555"},{"text":"ToolkitMC","color":"aqua","underlined":true,"clickEvent":{"action":"open_url","url":"https://github.com/ToolkitMC/macroEngine-dp"}}]

tellraw @s ["",{"text":"  ┃ ","color":"#555555"},{"text":"Source    ","color":"gray"},{"text":"github.com/ToolkitMC/macroEngine-dp","color":"#5555ff","underlined":true,"clickEvent":{"action":"open_url","url":"https://github.com/ToolkitMC/macroEngine-dp"}}]
# Check if loaded
