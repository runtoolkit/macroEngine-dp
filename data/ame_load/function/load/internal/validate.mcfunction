execute unless data storage macro:engine global run data modify storage macro:engine global set value {version:"v2.2.2"}
data modify storage macro:engine global.version set value "v2.2.2"
