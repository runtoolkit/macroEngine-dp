...
# do not match expected values (1, 0, 6, pre=2).
#
# Responsibilities:
...
setblock -30000000 0 1600 minecraft:test_block[mode=log]{mode:"log",message:"❌ [AME] Version conflict detected. Expected v1.0.6-pre3. Run /reload in-game for details."}
