# macro:systems/rate_limit/player/config — Register per-player rate limit rule [MACRO]
#
...
#
# This allows: $function macro:systems/rate_limit/player/check {key:"shop",player:"$(player)"}
#
